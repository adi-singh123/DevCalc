...
export default function OmagelPromoBanner() {
  const [dismissed, setDismissed] = useState(() => {
    try { return sessionStorage.getItem("omagel_promo_closed") === "true"; }
    catch { return false; }
  });
  ...
  return (
    <div className="my-5 w-full" data-testid="omagel-promo">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] sm:text-xs text-stone-600 dark:text-slate-400 max-w-xl">
                Guest text and video conversations for adults aged 18 and over. Matching depends on who is available.
              </p>
            </div>
          </div>

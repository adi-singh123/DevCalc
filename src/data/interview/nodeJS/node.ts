...
export const nodeQuestions: InterviewQuestion[] = [
  ...
  },
  {
    ...
    options: ['"function"', '"object"', '"undefined"', '"module"'],
  ...
  },
  {
    ...
    options: ['window', 'global', 'module', 'self'],
  ...
  },
  {
    ...
    options: ['window', 'global', 'root', 'self'],
  ...
  },
  {
    ...
    options: ['npm install', 'npm start', 'npm init', 'npm build'],
  ...
  },
  {
    ...
    options: ['process.args', 'process.argv', 'process.params', 'os.argv'],
  ...
  },
  {
    ...
    options: ['Promise { 1 }', '1', 'undefined', 'An error is thrown'],
    correctAnswer: '1',
  ...
  },
  {
    ...
    options: ['run app.js', 'node app.js', 'npm app.js', 'node start app.js'],
  ...
  },
  {
    ...
    options: ['Jest, Mocha, and Vitest', 'Webpack and Babel', 'Express and Koa', 'PM2 and nodemon'],

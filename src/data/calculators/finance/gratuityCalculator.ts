...
keywords: [
  ...
  "retirement settlement calculator",
  "superannuation calculator",
  "retirement corpus calculator",
  "retirement compensation calculator",
  ...
  "salary gratuity calculator",
  "last drawn salary gratuity calculator",
  "basic salary gratuity calculator",
  "salary benefit calculator",
  "salary payout calculator",
  "salary settlement calculator",
  "monthly salary gratuity calculator",
  "salary and service calculator",
  "salary based gratuity calculator",
  "employee salary benefit calculator",

  // Service Years Keywords
  "years of service gratuity calculator",
  "service period calculator",
  "employment duration calculator",
  "work experience gratuity calculator",
  "service tenure calculator",
  "service years benefit calculator",
  "employee tenure calculator",
  "long service benefit calculator",
  "service completion calculator",
  "years worked calculator",

  // Formula Keywords
  "gratuity formula",
  "gratuity calculation formula",
  "gratuity equation calculator",
  "how to calculate gratuity",
  "payment of gratuity act formula",
  "gratuity amount formula",
  "employee gratuity formula",
  "salary gratuity formula",
  ...
  "minimum service gratuity calculator",
  "5 years service gratuity calculator",
  "employee eligibility calculator",
  "gratuity qualification calculator",
  "service eligibility calculator",
  "gratuity rules india",
  "gratuity entitlement calculator",
  "gratuity benefit eligibility",

  // Labour Law Keywords
  "payment of gratuity act calculator",
  "labour law gratuity calculator",
  "employee benefit law calculator",
  "gratuity act india",
  "gratuity law calculator",
  "employment law calculator",
  "salary law calculator",
  "workplace benefits calculator",
  "employee rights calculator",
  "statutory benefits calculator",

  // Tax & Financial Keywords
  "gratuity tax calculator",
  "gratuity tax exemption calculator",
  "retirement tax calculator",
  "employee tax benefit calculator",
  "gratuity financial calculator",
  "tax free gratuity calculator",
  "retirement financial planning calculator",
  "salary tax benefit calculator",
  "employee wealth calculator",
  ...
  "payment of gratuity act explained",
  "gratuity examples",
  "gratuity calculation example",
  "employee gratuity guide",
  ...
  "employee gratuity india",
  "retirement benefits india",
  "salary gratuity calculator india",
  "gratuity amount calculator india",
  "service benefit calculator india",
  "gratuity law india",
  ...
  "gratuity formula hindi",
  "ग्रेच्युटी कैलकुलेटर",
  "ग्रेच्युटी राशि कैलकुलेटर",
  "कर्मचारी ग्रेच्युटी कैलकुलेटर",
  "ग्रेच्युटी गणना",
  "ग्रेच्युटी फॉर्मूला",
  "ग्रेच्युटी कैसे निकाले",
  "सेवानिवृत्ति ग्रेच्युटी कैलकुलेटर",
  "ग्रेच्युटी पात्रता कैलकुलेटर",
  "भारत ग्रेच्युटी कैलकुलेटर",
  "ग्रेच्युटी लाभ कैलकुलेटर",
  "पेमेंट ऑफ ग्रेच्युटी एक्ट",

  // Long Tail Keywords
  "free online gratuity calculator",
  "best gratuity calculator india",
  "gratuity calculator with formula",
  "accurate gratuity amount calculator",
  "employee gratuity calculator by years of service",
  "retirement gratuity payout calculator",
  "last drawn salary gratuity calculator online",
  "payment of gratuity act calculator india",
  "advanced gratuity eligibility calculator",
  "gratuity estimate calculator for employees",
],
  },

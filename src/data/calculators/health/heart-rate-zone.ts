...
export const heartRateZoneCalculator: Calculator = {
  ...
  faqs: [
    ...
    {
      question:
        "Should I train in Zone 2 or Zone 4 for fat loss?",
      answer:
        "Zone 2 relies primarily on fat oxidation for fuel and builds long-term mitochondrial efficiency. Zone 4 burns more total calories per minute but derives energy mainly from carbohydrates, so combining steady Zone 2 sessions with occasional Zone 4 intervals yields the best metabolic results.",
    },
  ],

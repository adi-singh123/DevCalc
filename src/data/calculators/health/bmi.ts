...
keywords: [
  ...
  "ideal bmi for men",
  "ideal bmi for women",
  "gender bmi calculator",

  // Age Keywords
  "bmi by age calculator",
  "healthy bmi range by age",
  "adult bmi chart by age",
  "bmi calculator age and gender",
  "bmi age calculator",
  "normal bmi by age",
  ...
  "healthy weight status calculator",
  "body weight status calculator",
  "medical bmi calculator",
  "clinical bmi calculator",
  "health risk bmi calculator",

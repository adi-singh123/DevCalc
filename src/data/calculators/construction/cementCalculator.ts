...
export const cementCalculator: Calculator = {
  ...
  seo: {
    ...
    description:
      "Free online Cement Calculator. Calculate cement quantity, cement bags, cement weight, and construction cost for slabs, foundations, columns, and concrete work.",

...
export const paintCalculator: Calculator = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "litres of paint needed for a room",
      "paint calculator per sq ft",
      "exterior paint calculator",
      "interior paint calculator",
      "paint cost calculator",
      "number of paint cans needed",
      "how much paint for 1000 sq ft house",
      "how much paint for one room",
      "emulsion paint calculator",
      "distemper paint calculator",
      "paint calculator for walls and ceiling",
      "asian paints calculator",
      "berger paint calculator",
      "paint quantity for 2 coats",
      "how many litres of paint per sq ft",
      "paint estimation for house",
      "wall area to paint litres",
      "paint calculator 2026",
      "how much does it cost to paint a house in india",
      "paint calculator with wastage",
      "primer and paint calculator",
      "how much paint for a 2bhk flat",
      "how much paint for a 3bhk flat",
    ],
  },

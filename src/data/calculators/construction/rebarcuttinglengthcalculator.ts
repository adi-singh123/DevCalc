...
export const rebarCuttingLengthCalculator: Calculator = {
  ...
  seo: {
    ...
    keywords: [
    "free rebar cutting length calculator",
      "rebar cutting length calculator",
      "bar bending schedule calculator",
      "BBS calculator online",
      "cutting length of stirrup calculator",
      "bend deduction calculator",
      "steel bar weight calculator",
      "IS 2502 cutting length formula",
      "hook length calculator rebar",
      "cutting length formula for slab",
      "cutting length of column bar",
      "TMT bar weight calculator",
      "reinforcement cutting length india",
      "rebar cutting length formula",
      "bar bending schedule formula india",
      "D2/162 steel weight formula",
      "cutting length of stirrup formula",
      "rebar cutting length calculator india",
      "bar cutting length calculator for beam",
      "cutting length of crank bar",
      "concrete cover deduction calculator",
      "steel quantity calculator construction",
      "how to calculate cutting length of rebar",
      "how to calculate bend deduction",
      "how to calculate hook length in bbs",
      "rebar cutting length calculator 2026",
      "bar bending schedule calculator with weight",
      "cutting length calculator for footing",
      "quantity surveyor steel calculator",
      "rebar fabrication length calculator",
      "civil engineering steel calculator india",
    ],
  },

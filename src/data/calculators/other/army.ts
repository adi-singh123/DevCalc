...
export const armyCalculator: Calculator = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "army height calculator",
      "army weight calculator",
      "army bmi calculator",
      "army running calculator",
      "army age calculator",
      "army eligibility calculator",
      "agniveer calculator",
      "agniveer height weight calculator",
      "agniveer eligibility calculator 2026",
      ...
      "army pushup calculator",
      "army situp calculator",
      "army fitness score calculator",
      "army bmi chart male female",
      "army height chart india",
      "army weight chart for height",
      "soldier gd eligibility calculator",
      "army physical standards 2026",
      "army medical standards calculator",
    ],
  },

...
export const partyBudgetCalculator: Calculator = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "birthday party cost calculator india",
      "party cost calculator",
      "kids birthday party budget calculator",
      "how much does a birthday party cost in india",
      "party budget planner",
      "birthday party budget breakdown",
      "return gift cost per child calculator",
      "party catering cost calculator",
      "anniversary party cost calculator",
      "house party budget calculator",
      "party decoration cost calculator",
      "birthday party cost for 50 guests",
      "party budget calculator india 2026",
      "banquet hall party cost calculator",
      "cost of birthday party at home",
      "party per plate cost calculator",
      "adult birthday party budget calculator",
      "surprise party cost calculator",
      "get together party cost calculator",
    ],
  },

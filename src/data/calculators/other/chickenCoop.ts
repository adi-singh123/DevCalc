...
export const chickenCoopCalculator: Calculator = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "chicken coop square feet per chicken",
      ...
      "backyard chicken coop calculator",
      "roosting bar space per chicken",
      "bantam chicken coop size",
      "chicken coop and run calculator",
      "how big should my chicken coop be",
      "nesting box size chart",
      "chicken coop ventilation requirements",
      "chicken coop dimensions guide",
      "how many chickens per square foot",
      "chicken coop overcrowding",
      "free range chicken coop size",
      "chicken coop planning calculator",
      "large breed chicken coop size",
      "chicken coop square footage chart",
      "how many chickens can my coop hold",
      "chicken coop size chart by breed",
      "roost bar length calculator",
      "chicken coop predator proofing",
      "chicken coop building calculator",
    ],
  },
